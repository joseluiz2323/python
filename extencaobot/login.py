...
if kurd == '1':
    ...
    while True:
        req_report_spam = requests.post(
            url_report_spam, data=data_report_spam, headers=headers_report_spam).text
        ...
        req_report_self = requests.post(
            url_report_self, data=data_report_self, headers=headers_report_self).text
        ...
        req_report_suicide = requests.post(
            url_report_suicide, data=data_report_suicide, headers=headers_report_suicide).text
        ...
        req_report_violence = requests.post(
            url_report_violence, data=data_report_violence, headers=headers_report_violence).text
...
if kurd == '2':
    ...
    if kurd2 == '1':
        ...
        req_login2 = requests.post(
            url_login, data=data_login, headers=headers_login)
        ...
        while True:
            req_spam2 = requests.post(
                url_report_spam2, data=data_report_spam2, headers=headers_report_spam2).text
    ...
    if kurd2 == '2':
        ...
        req_login3 = requests.post(
            url_login3, data=data_login3, headers=headers_login3)
        ...
        while True:
            req_self = requests.post(
                url_report_self2, data=data_report_self2, headers=headers_report_self2).text
    ...
    if kurd2 == '3':
        ...
        req_login4 = requests.post(
            url_login4, data=data_login4, headers=headers_login4)
        ...
        while True:
            req_ant7ar = requests.post(
                url_report_suicide2, data=data_report_suicide2, headers=headers_report_suicide2).text
    ...
    if kurd2 == '4':
        ...
        req_login5 = requests.post(
            url_login5, data=data_login5, headers=headers_login5)
        ...
        while True:
            req_3nf = requests.post(
                url_report_violence2, data=data_report_violence2, headers=headers_report_violence2).text
